...
var app = (function () {
    ...
    const file$5 = "src/common/Flex.svelte";
    ...
    const file$4 = "src/common/Button.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 4, 0, 42);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (10:2) <Post title="CSS Practice" date="August 30, 2020" enclosedTitle>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(10:2) <Post title=\\\"CSS Practice\\\" date=\\\"August 30, 2020\\\" enclosedTitle>",
    		ctx
    	});
    ...
    // (13:2) <Post date="August 29, 2020" title="v2" enclosedTitle>
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$1, 13, 4, 400);
    			add_location(p1, file$1, 19, 4, 670);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p0, anchor);
    			insert_dev(target, t1, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(13:2) <Post date=\\\"August 29, 2020\\\" title=\\\"v2\\\" enclosedTitle>",
    		ctx
    	});
    ...
    // (25:2) <Post date="May 31, 2020" title="Unrest" enclosedTitle>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$1, 25, 4, 846);
    			add_location(strong0, file$1, 33, 35, 1170);
    			add_location(strong1, file$1, 34, 6, 1208);
    			add_location(strong2, file$1, 34, 35, 1237);
    			add_location(p1, file$1, 32, 4, 1131);
    			add_location(li0, file$1, 38, 6, 1305);
    			add_location(li1, file$1, 39, 6, 1368);
    			add_location(li2, file$1, 40, 6, 1425);
    			add_location(li3, file$1, 41, 6, 1485);
    			add_location(li4, file$1, 45, 6, 1632);
    			add_location(strong3, file$1, 47, 8, 1689);
    			add_location(li5, file$1, 46, 6, 1676);
    			add_location(ul, file$1, 37, 4, 1294);
    			add_location(p2, file$1, 54, 4, 1838);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p0, anchor);
    			insert_dev(target, t1, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(25:2) <Post date=\\\"May 31, 2020\\\" title=\\\"Unrest\\\" enclosedTitle>",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 5, 0, 120);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ CssPractice1, Post });
    	return [];
    }
