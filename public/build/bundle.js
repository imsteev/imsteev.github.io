...
var app = (function () {
    ...
    const file$b = "src/posts/Post.svelte";
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$b, 7, 4, 121);
    			add_location(div1, file$b, 8, 4, 158);
    			attr_dev(div2, "class", "header-title svelte-t7o56v");
    			add_location(div2, file$b, 6, 2, 90);
    			attr_dev(div3, "class", "svelte-t7o56v");
    			add_location(div3, file$b, 10, 2, 187);
    			attr_dev(div4, "class", "post-container svelte-t7o56v");
    			add_location(div4, file$b, 5, 0, 59);
    		},
    ...
    class Post extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$b, create_fragment$b, safe_not_equal, { date: 0, title: 1 });
    ...
    const file$a = "src/posts/PostLexicalScope.svelte";

    // (5:0) <Post date="March 14, 2021" title="Lexical scope in Javascript">
    function create_default_slot$5(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(5:0) <Post date=\\\"March 14, 2021\\\" title=\\\"Lexical scope in Javascript\\\">",
    		ctx
    	});
    ...
    const file$9 = "src/common/Flex.svelte";
    ...
    class Flex extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$9, create_fragment$9, safe_not_equal, { justifyContent: 0 });
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$8, 4, 0, 42);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$7 = "src/posts/PostCSSPractice.svelte";
    ...
    function create_default_slot$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$7, 9, 2, 244);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    const file$6 = "src/posts/PostShibaGenerator.svelte";
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$6, 35, 8, 877);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(figure, file$6, 33, 4, 795);
    		},
    		m: function mount(target, anchor) {
    ...
    const file$5 = "src/posts/PostUnrest.svelte";
    ...
    function create_default_slot$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$5, 5, 2, 114);
    			add_location(strong0, file$5, 13, 33, 424);
    			add_location(strong1, file$5, 14, 4, 460);
    			add_location(strong2, file$5, 14, 33, 489);
    			add_location(p1, file$5, 12, 2, 387);
    			add_location(li0, file$5, 18, 4, 551);
    			add_location(li1, file$5, 19, 4, 612);
    			add_location(li2, file$5, 20, 4, 667);
    			add_location(li3, file$5, 21, 4, 725);
    			add_location(li4, file$5, 25, 4, 864);
    			add_location(strong3, file$5, 27, 6, 917);
    			add_location(li5, file$5, 26, 4, 906);
    			add_location(ul, file$5, 17, 2, 542);
    			add_location(p2, file$5, 34, 2, 1054);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p0, anchor);
    			insert_dev(target, t1, anchor);
    ...
    const file$4 = "src/posts/PostV2.svelte";
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$4, 5, 2, 113);
    			add_location(p1, file$4, 11, 2, 371);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p0, anchor);
    			insert_dev(target, t1, anchor);
    ...
    const file$3 = "src/posts/PostV3.svelte";
    ...
    const file$2 = "src/AllPosts.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 10, 2, 374);
    			attr_dev(div, "class", "svelte-15dlnjf");
    			add_location(div, file$2, 9, 0, 366);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/MetaHeader.svelte generated by Svelte v3.35.0 */

    const file$1 = "src/MetaHeader.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "class", "svelte-hy9q18");
    			add_location(a0, file$1, 3, 4, 73);
    			attr_dev(a1, "href", "https://www.linkedin.com/in/imsteev/");
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "class", "svelte-hy9q18");
    			add_location(a1, file$1, 5, 4, 156);
    			add_location(div1, file$1, 2, 2, 63);
    			attr_dev(div2, "class", "meta-info-container svelte-hy9q18");
    ...
    function instance$1($$self, $$props) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("MetaHeader", slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<MetaHeader> was created with unknown prop '${key}'`);
    	});

    	return [];
    }

    class MetaHeader extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment(ctx) {
    	...
    	let allposts;
    	let current;
    	metaheader = new MetaHeader({ $$inline: true });
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ AllPosts, MetaHeader });
    	return [];
    }
